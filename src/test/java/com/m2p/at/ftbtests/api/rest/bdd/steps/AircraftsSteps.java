...
public class AircraftsSteps {
    ...
    @When("client tries to create an Aircraft having null number of seats, manufacturer={string} and model={string}")
    ...
    @Then("aircraft data with null number of seats, manufacturer={string} and model={string}")
    @Then("returned aircraft data with null number of seats, manufacturer={string} and model={string}")
